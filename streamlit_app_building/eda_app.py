...
def EDA():
   ...
   # ============================= soil type ===================================================
    ...
    st.write('**_To get the complete code for this project use below given github link_**')
    st.write('[GitHub](https://github.com/Basavaraj100/forest_cover_type_prediction)')
    st.write('**_To get the project explained vedio in linked in use below link_**')
    st.write('[linkedin](https://www.linkedin.com/posts/basavaraj-bijali-31051997_datascience-internship-machinelearning-activity-6841006360109441024-gy04)')
